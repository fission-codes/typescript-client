...
Format your code using Prettier. Either use automatic formatting in your editor of choice. Or run `npm run format-staged` to lint and format files staged for commit.
